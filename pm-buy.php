...
>
  ...
  <body>
        ...
        ?>
                          ...
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/perfectmoney-logo.png" alt="Perfect money Logo" style="width:20px">PM DEPOSIT</h5>
                                <!--<button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                <div class="row">
                                <span class="alert alert-info">Rate = &#x20A6;<?php echo $pm_buy; ?>/&#36;
                                <!-- Hidden PM Rate To be Used In Jquery Rate Calculation -->
                                <input type="text" name="price" id="price" <?php echo "value='$pm_buy'"; ?> hidden/>
                       ...
                       <!-- PM Buy Funds Modal -->
                        ...
                        >
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/perfectmoney-logo.png" alt="Perfect money Logo" style="width:20px"><b>PM DEPOSIT</b></h5>
                                </div>
                    ...
                    $time = date('H:i:s');
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                                ...
                                $message .= "<p style='font-size:14px;margin:0 0 6px 0;'><span style='font-weight:bold;display:inline-block;min-width:150px'>Order type</span> Perfect Money USD Purchase</p>";
                    ...
                    ?>
                         ...
                         <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <br>
                                ...
                                <br>
                                <div class='alert alert-danger'>***Your account details should match your Perfect Money name. No third parties***</div>
                                </div>            
                                </div>
                            </div>
                            </div>
                    ...
                    <script>
                      ...
                      <!-- End of order paid successful modal -->
                                ...
                                <form method="POST" action="pm-buy-validation.php" name="frmChange" onSubmit="return validatebtcbuy()">
                                ...
                                <div class="row g-2">                                  
                                  <div class="col mb-0"> 
                                    <label for="AccountDetails" class="form-label">Your PM Account</label>
                                    <input type="text" id="pmid" name="pmid" class="form-control" placeholder="Your PM Account" pattern="^(u|U|x|X)[0-9]{1,}$" title="You have entered invalid PM account number" minlength="8" required/>
                                    <span id="PerfectMoneyID" class="required"></span> 
                                     <?php $reason = array("invalid_pmidcredential=true" => "<p style='color:red;'>Your PM ID is required</p>"); 
                                     if(isset($_GET['purchaseFailedinvalidpmid'])) echo $reason[$_GET['reason']]; ?>
                                  </div>
                              ...
                              <div class="modal-footer">
                                ...
                                <?php
                                  ...
                                  if ($row['verification_status']==$verification_status){
                                    ...
                                    echo "<button type='submit' name='pmbuy' class='btn btn-primary'>Place Order</button>";
                                 }
                                 }
    ...
    <!-- PM Jquery rate calculator script -->
    <script>
