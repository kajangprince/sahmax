        ...
        <!-- Content wrapper -->
          <div class="content-wrapper">
                 ...
                 <div class="table-responsive text-nowrap">
                        ...
                        <tr>
                            <td>
                                <center class="card-header">
                                    <button type="submit" name="unpaid" class="btn btn-outline-primary">Unpaid orders</button>
                                </center>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            <td>
                                <center class="card-header">
                                    <button type="submit" name="paid" class="btn btn-outline-primary">Paid orders</button>
                                </center>
                    ...
                    <table>
                        <tr>
                            <td>
                                <center class="card-header">
                                    <button type="submit" name="completed" class="btn btn-outline-primary">Completed orders</button>
                                </center>
                            ...
                            <footer style='border: 1px solid #969696;'>
                              <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <span style='color:#FF0000'>pending</span><br><b>Pay to $account_details account</b>
                                </div>
                                <div>
                                  ...
                                  <a href='javascript:void(0)' class='btn btn-sm btn-outline-danger' data-bs-toggle='modal' data-bs-target='#cancelOrderModal'
                          ...
                          echo "<footer style='border: 1px solid #969696;'>
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <div class='dropdown dropup footer-link me-3'>
                                    <button type='button' class='btn btn-sm btn-outline-info dropdown-toggle' data-toggle='modal' data-target='#paidModal'>
                                      View order
                                    </button>
            ...
            ?>
                ...
                $stmt =  $stmt = $con->prepare("SELECT * FROM buy_order WHERE order_status = :order_status AND user_id = :user_id");
                $stmt->bindParam(':user_id', $user_id);
                $stmt->bindParam(':order_status', $order_status);
                $stmt->execute();
                if($stmt){
                        ...
                        $time = date('h:i A', $timestamp);
                          ...
                          echo "<footer style='border: 1px solid #969696;'>
                              ...
                              >
                                <div>
                                  <a href='javascript:void(0)' class='footer-text fw-bolder'>Order type - $dollar_type USD | Order ID - $order_id | <span style='width:10px;color:#03B0D4'><i class='bx bx-time'></i></span> $time<img src='images/star.gif' style='width:15px;height:15px'></a><br>
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <span style='color:#03C3EC'>completed</span><br><b>Paid to $account_details account</b>
                                </div>
                                <div>
                                  <div class='form-check form-control-sm footer-link me-3'>
                                    <button type='button' class='btn btn-sm btn-outline-primary' disabled>
            ...
            ?>
              ...
              <!--/ Basic Bootstrap Table -->
                    ...
                    <!-- Cancel order Modal -->
                      <div class="modal fade" id="cancelOrderModal" data-backdrop="static" tabindex="-1" aria-hidden="true">
