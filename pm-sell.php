...
>
  ...
  <body>
        ...
        ?>
                          ...
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/perfectmoney-logo.png" alt="Perfect Money Logo" style="width:20px">PM SELL</h5>
                                <!--<button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                <div class="row">
                                <span class="alert alert-info">Rate = &#x20A6;<?php echo $pm_sell; ?>/&#36;
                                <!-- Hidden Perfect Money Rate To be Used In Jquery Rate Calculation -->
                                <input type="text" name="price" id="price" <?php echo "value='$pm_sell'"; ?> hidden/>
                                <br>Limit Min. 20 USD = &#x20A6;<?php $pm_min_quantity = "20"; 
                                $total_pm_min_amount = $pm_sell * $pm_min_quantity;
                                /* Format Amount to decimal place */
                                $formatted_total_pm_min_amount = number_format($total_pm_min_amount); echo"$formatted_total_pm_min_amount"; ?> </span>
                               ...
                               // CALL MODAL HERE IF ORDER_PLACED
                                ...
                                if ($payment_status=="1" AND $dollar_type=="PM"){
                        ...
                        > 
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/perfectmoney-logo.png" alt="Perfect Money Logo" style="width:20px"><b>PM SELL</b></h5>
                                </div>
                                <div class='modal-body text-center'>
                                    ...
                                    transactions. Your bank account information must tally with your Sahmax Optimum and Perfect Money account name.</div>  
                                <div class='' style='font-size:15px'>
                                    <span><b>ORDER INSTRUCTIONS:</b></span><br>                       
                                    <b>1.</b> Send <?php echo "<b>$$amount_in_usd</b>"; ?> to the Perfect Money Account below <br>
                                    <input style="width:100px;" type="text" value="U28636170" id="myInput" title="Sahmax Optimum Perfect Money Acc ID" readonly> (Sulaiman Saheed Adekunle)
                                    <p id="myTooltip" onclick="CopyLink()"><button class="btn btn-sm btn-outline-danger"><i class="fa fa-copy" style="font-size:12px;"></i> Copy ID</button></p> <br>
                                    ...
                                    function CopyLink() {
                                      ...
                                      tooltip.innerHTML = "<button class='btn btn-primary btn-sm shadow-none'>PM ID copied</button>";
                    ...
                    $time = date('H:i:s');
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                                ...
                                $message .= "<p style='font-size:14px;margin:0 0 6px 0;'><span style='font-weight:bold;display:inline-block;min-width:150px'>Order type</span> PM USD sell</p>";
                    			...
                    			$subj = "Order Marked Paid ($$formatted_amount_in_usd PM Sell Order)";
                    ...
                    <script>
                      ...
                      <!-- End of order paid successful modal -->
                                ...
                                <form method="POST" action="pm-sell-validation.php" name="frmChange" onSubmit="return validatePMSell()">
                              ...
                              <div class="modal-footer">
                                ...
                                <?php
                                  ...
                                  if ($row['verification_status']==$verification_status){
                                    ...
                                    echo "<button type='submit' name='pmsell' class='btn btn-primary'>Place Order</button>";
                                 }
                                 }
    ...
    <!-- Perfect Money Jquery rate calculator script -->
    <script>
    ...
    $("form#PMBuyForm").submit(function(){ // on form submit
