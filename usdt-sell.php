    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        ?>
                          ...
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                <span class="alert alert-info">Rate = &#x20A6;<?php echo $usdt_sell; ?>/&#36;
                                <!-- Hidden USDT Rate To be Used In Jquery Rate Calculation -->
                                <input type="text" name="price" id="price" <?php echo "value='$usdt_sell'"; ?> hidden/>
                                <br>Limit Min. 20 USD = &#x20A6;<?php $usdt_min_quantity = "20"; 
                                $total_usdt_min_amount = $usdt_sell * $usdt_min_quantity;
                               ...
                               // CALL MODAL HERE IF ORDER_PLACED
                                ...
                                while($row = $stmt->fetch()){
                                   ...
                                   $formatted_amount_in_usd = number_format($amount_in_usd, 2);
                                    ...
                                    $unformatted_amount_in_naira = $amount_in_usd * $usdt_sell;
                                    $amount_in_naira = number_format($unformatted_amount_in_naira, 2);
                                
                                if ($payment_status=="1" AND $dollar_type=="USDT"){
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <div class='' style='font-size:15px'>
                                    ...
                                    <b>1.</b> Send <?php echo "<b>$$amount_in_usd</b>"; ?> worth of USDT to the address below <br>
                                    <input style="width:300px;" type="text" value="TLDnGderPbVWbtNLYA6cyjo8QqTkmJ2Npz" id="myInput" title="Sahmax Optimum USDT address" readonly>
                    ...
                    $stmt = $con->prepare("SELECT usdtsell FROM rates WHERE email = :support_email LIMIT 1");
                    ...
                    $time = date('H:i:s');
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                                ...
                                $message .= "<p style='font-size:14px;margin:0 0 6px 0;'><span style='font-weight:bold;display:inline-block;min-width:150px'>Order type</span> USDT USD sell</p>";
                    			...
                    			$subj = "Order Marked Paid ($$formatted_amount_in_usd USDT Sell Order)";
                    ...
                    <script>
                        ...
                        <div class="modal-header" style="background: #1ab394; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                            ...
                            <div class="modal-body">
                                <?php 
                                    //Get order Naira amount
                                    $unformatted_amount_in_usd = $amount_in_usd * $usdt_sell; 
                      ...
                      <!-- End of order paid successful modal -->
                                ...
                                <form method="POST" action="usdt-sell-validation.php" name="frmChange" onSubmit="return validateUSDTSell()">
                              ...
                              <div class="modal-footer">
                                ...
                                <?php
                                  ...
                                  if ($row['verification_status']==$verification_status){
                                    ...
                                    echo "<button type='submit' name='usdtsell' class='btn btn-primary'>Place Order</button>";
                                 }
                                 }
