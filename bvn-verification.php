...
>
  <head>
    ...
    <title>Account Verification - Step 1 of 2</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account Verification /</span> BVN</h4>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                        ...
                        <?php $reason = array("wrong_bvn_validation=true" => "<div class='card-body alert alert-danger' style='color:#FF0000;'>
                        <center>Your BVN is needed!</center></div>"); 
                        if(isset($_GET['validationFailed'])) echo $reason[$_GET['reason']]; ?>
                        
                        <?php $reason = array("wrong_bvn_number=true" => "<div class='card-body alert alert-danger' style='color:#FF0000;'>
                        <center>Wrong BVN format!</center></div>"); 
                        if(isset($_GET['validationFailed'])) echo $reason[$_GET['reason']]; ?>
                        
                        <?php $reason = array("wrong_bvn_length=true" => "<div class='card-body alert alert-danger' style='color:#FF0000;'>
                        <center>Wrong BVN format!</center></div>"); 
                        if(isset($_GET['validationFailed'])) echo $reason[$_GET['reason']]; ?>
                        
                        <?php $reason = array("unknownerror=true" => "<div class='card-body alert alert-danger' style='color:#FF0000;'>
                        <center>Unknown error occured!</center></div>"); 
                        if(isset($_GET['validationFailed'])) echo $reason[$_GET['reason']]; ?>
                        
                        <?php $reason = array("bvndeleted=true" => "<div class='card-body alert alert-success' style='color:#008000;'>
                        <center>Review cancelled, resubmit your documents</center></div>"); 
                        if(isset($_GET['deleted'])) echo $reason[$_GET['reason']]; ?>
                        
                        <?php $reason = array("bvndeletedFailed=true" => "<div class='card-body alert alert-danger' style='color:#FF0000;'>
                        <center>Failed to cancel review! Unknown error occured</center></div>"); 
                        if(isset($_GET['deletedFailed'])) echo $reason[$_GET['reason']]; ?>
                        
                        <?php $reason = array("bvnexist=true" => "<div class='card-body alert alert-info'>
                      ...
                      <a href='registration-form'><div class='btn btn-sm btn-outline-primary'>Fill your info</div></a>
                          ...
                          if ($row['verification_status']==$verification_status){
                            ...
                            <h5 class='card-header'><center>Step 1 of 2 - BVN Validation</center></h5>
                            <span style='margin-top:-20px'><center>Submit your BVN, ensure all your personal details are the same.</center></span>
                        <div class='card-body'>                     
                        <div class='button-wrapper'>
                            
                        <form action='bvn-validation' method='POST'>
                          <center><label for='upload' class='btn btn-primary me-2 mb-4' tabindex='0'>
                            <span class='d-none d-sm-block'>Enter BVN</span>
                            <i class='bx bx-user d-block d-sm-none'>Enter BVN</i>
                            <input type='number' id='upload' class='form-control' name='bvn' maxlength='11' minlength='11' required/>
                          </label>
                          <button type='submit' name='submit' class='btn btn-outline-primary mb-4'>
                            ...
                            echo "<h5 class='card-header' style='color:#008000'>
