      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <?php echo"<a class='nav-link active' href='admin-message-users'><i class='bx bx-message'></i>Message Users</a>"; ?>
                    </li>
                  </ul>
            ...
            $email_array = [];
            $stmt = $con->prepare("SELECT * FROM users WHERE account_status = :account_status AND subscribe = :subscribe AND verification_status = :verification_status");
            $stmt->execute(array('account_status' => $account_status,'subscribe' => $subscribe,'verification_status' => $verification_status));
            ...
            foreach ($email_array as $fetched_emails) {
                
            $useremail = "$fetched_emails";
	    	...
	    	if ($mailsend) {
                ...
                echo"<div class='alert alert-success'>Mail has been sent to all users</div>";
                $con = null;
                
            } else {
                
                echo"<div class='alert alert-danger'>No user is eligible to receive mail now</div>";
                $con = null;
...
?>
                    ...
                    <div class="card mb-4">
                    <hr class="my-0" />
                    <h5 class="card-header" style="text-transform:capitalize">Message Users</h5>
                    <div class="card-body">
