...
>
  <head>
    ...
    <title>Admin active buy orders</title>
          ...
          <div class="content-wrapper">
            ...
            <br>
              ...
              <div class="card">
                ...
                <h5 class="card-header">Paid Buy Orders</h5>
                            ...
                            <footer style='border: 1px solid #969696;'>
                              ...
                              >
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <img src='$receipt' style='width:50px;height:50px'> | <span style='color:#03C3EC'> paid </span><br><b>Paid to $account_details account</b> |
                                ...
                                <div class='form-check form-control-sm footer-link me-3'>
                    			<form action='admin-active-buy-orders' method='POST'>
                                ...
                                <br>
                                <div class='form-check form-control-sm footer-link me-3'>
                                    <a href='admin-cancel-buy-order?oid=$order_id' class='btn btn-sm btn-outline-danger'><i class='bx bx-log-out-circle'></i> Cancel</a>
                                </div>
              ...
              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Unpaid Buy Orders</h5>
                 ...
                 <div class="table-responsive text-nowrap">
                    ...
                    $stmt = $con->prepare("SELECT id , user_id, dollar_type , order_id , amount_in_naira , account_details, receipt , payment_status , order_status , time , date from buy_order WHERE order_status = :order_status AND payment_status = :payment_status");
                    $stmt->bindParam(':order_status', $order_status);
                    $stmt->bindParam(':payment_status', $payment_status);
                    $stmt->execute();
                    if($stmt){
                            ...
                            echo "<footer style='border: 1px solid #969696;'>
                              ...
                              >
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <span style='color:#E6381A'> unpaid </span><br><b>Paying to $account_details account</b>
                                </div>
                                <div>
