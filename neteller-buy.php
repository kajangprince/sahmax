    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        ?>
                          ...
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/neteller-logo.png" alt="Neteller Logo" style="width:20px">Neteller DEPOSIT</h5>
                                <!--<button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                <div class="row">
                                <span class="alert alert-info">Rate = &#x20A6;<?php echo $neteller_buy; ?>/&#36;
                                <!-- Hidden Neteller Rate To be Used In Jquery Rate Calculation -->
                                <input type="text" name="price" id="price" <?php echo "value='$neteller_buy'"; ?> hidden/>
                                <br>Limit Min. 20 USD = &#x20A6;<?php $neteller_min_quantity = "20"; 
                                $total_neteller_min_amount = $neteller_buy * $neteller_min_quantity;
                               ...
                               // CALL MODAL HERE IF ORDER_PLACED
                                ...
                                while($row = $stmt->fetch()){
                                   ...
                                   $formatted_amount_in_naira = number_format($amount_in_naira, 2);
                                    ...
                                    $unformatted_amount_in_dollar = $amount_in_naira / $neteller_buy;
                       ...
                       <!-- Neteller Buy Funds Modal -->
                        ...
                        >
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/neteller-logo.png" alt="Neteller Logo" style="width:20px"><b>Neteller DEPOSIT</b></h5>
                                </div>
                                <div class='modal-body text-center'>
                                    <div class='alert alert-danger'>***ORDER TERMS***<br>We will not be responsible for funding a wrong account provided by you.
                                    You must NOT use phrases like; bitcoin, btc, Neteller, Perfect Money, crypto, wallet, fund, buying etc in your transfer memo/details/narration/purpose 
                    ...
                    $stmt = $con->prepare("SELECT netellerbuy FROM rates WHERE email = :support_email LIMIT 1");
                    ...
                    $time = date('H:i:s');
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                                ...
                                $message .= "<p style='font-size:14px;margin:0 0 6px 0;'><span style='font-weight:bold;display:inline-block;min-width:150px'>Order type</span> Neteller USD Purchase</p>";
                    ...
                    ?>
                         ...
                         <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <br>
                                ...
                                <br>
                                <div class='alert alert-danger'>***Your account details should match your Neteller wallet name. No third parties***</div>
                                </div>            
                                </div>
                            </div>
                            </div>
                    ...
                    <script>
                      ...
                      <!-- End of order paid successful modal -->
                                ...
                                <form method="POST" action="neteller-buy-validation.php" name="frmChange" onSubmit="return validatebtcbuy()">
                                ...
                                <div class="row g-2">                                  
                                  <div class="col mb-0"> 
                                    <label for="AccountDetails" class="form-label">Your Neteller Email</label>
                                    <input type="email" id="netellerid" name="netellerid" class="form-control" placeholder="Your Neteller Email" title="You have entered invalid Neteller Email" required/>
                                    <span id="NetellerID" class="required"></span> 
                                     <?php $reason = array("invalid_netelleridcredential=true" => "<p style='color:red;'>Your Neteller Email is required</p>"); 
                                     if(isset($_GET['purchaseFailedinvalidnetellerid'])) echo $reason[$_GET['reason']]; ?>
                                  </div>
                              ...
                              <div class="modal-footer">
                                ...
                                <?php
                                  ...
                                  if ($row['verification_status']==$verification_status){
                                    ...
                                    echo "<button type='submit' name='netellerbuy' class='btn btn-primary'>Place Order</button>";
                                 }
                                 }
