...
>
  <head>
    ...
    <title>Account Verification - Step 3 of 3</title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                        ...
                        <center>Take a selfie with your verification document!</center></div>"); 
                        ...
                        <center>Document Back Received, Proceed to a selfie of you holding the document submission.</center></div>"); 
              ...
              <?php 
                        ...
                        if($row['verification_stage']=="1"){
                            ...
                            <center>Error in verification process, cancel this request and navigate to <a href='verification'>verification using sidenav</a> <br>
                      ...
                      <a href='registration-form'><div class='btn btn-sm btn-outline-primary'>Fill your info</div></a>
                          ...
                          if ($row['verification_status']==$verification_status){
                            ...
                            <h5 class='card-header'><center>Step 3 of 3 - Selfie with ID card</center></h5>
                            <div class='alert alert-info' style='margin-top:-20px'>
                            <center>&ast;Submit a selfie of you holding your document.</center></div>
                        <div class='card-body'>
                          <div class='d-flex align-items-start align-items-sm-center gap-4'>
                            <img src='images/selfie_with_ID.png' alt='Selfie with Document sample' class='d-block rounded' height='100' width='100' id='uploadedAvatar'
                            />
                        <div class='button-wrapper'>
                        <form action='verification-validation' method='POST' enctype='multipart/form-data'>
                           <div class='margin' style='margin-top:5px'></div>
                           <label class='form-label' for='document'>&ast;Take selfie with ID</label><br>
                          <label for='upload' class='btn btn-primary me-2 mb-4' tabindex='0' style='margin-top:-20p'>
                            <span class='d-none d-sm-block'>Capture document</span>
