...
>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        ?>
                          ...
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/bitcoin-btc-logo.svg" alt="Bitcoin Logo" style="width:20px">BITCOIN BUY</h5>
                                <!--<button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                ...
                                <span class="alert alert-info">Rate = &#x20A6;<?php echo $bitcoin_buy; ?>/&#36;
                                <!-- Hidden bitcoin Rate To be Used In Jquery Rate Calculation -->
                                <input type="text" name="price" id="price" <?php echo "value='$bitcoin_buy'"; ?> hidden/>
                                <input type="text" name="btcprice" id="btcprice" <?php echo "value='$btcprice'"; ?> hidden/>
                                <br>Limit Min. 50 USD = &#x20A6;<?php $bitcoin_min_quantity = "50"; 
                                $total_bitcoin_min_amount = $bitcoin_buy * $bitcoin_min_quantity;
                                /* Format Amount to decimal place */
                                $formatted_total_bitcoin_min_amount = number_format($total_bitcoin_min_amount); echo"$formatted_total_bitcoin_min_amount"; ?> </span>
                               ...
                               // CALL MODAL HERE IF ORDER_PLACED
                                ...
                                while($row = $stmt->fetch()){
                                   ...
                                   $formatted_amount_in_naira = number_format($amount_in_naira, 2);
                                    ...
                                    $unformatted_amount_in_dollar = $amount_in_naira / $bitcoin_buy;
                       ...
                       <!-- Bitcoin Buy Funds Modal -->
                        ...
                        >
                          <div class="modal-dialog modal-fullscreen" role="document"> 
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/bitcoin-btc-logo.svg" alt="Bitcoin Logo" style="width:20px"><b>BITCOIN BUY</b></h5>
                                </div>
                                <div class='modal-body text-center'>
                                    <div class='alert alert-danger'>***ORDER TERMS***<br>We will not be responsible for funding a wrong account provided by you.
                                    You must NOT use phrases like; bitcoin, btc, PM, Perfect Money, crypto, wallet, fund, buying etc in your transfer memo/details/narration/purpose 
                                ...
                                <div class='' style='font-size:15px'>
                                    ...
                                    <b>1.</b> Make payment of <?php echo "<b>$formatted_amount_in_naira</b>"; ?> Naira to the stated account details<br>
                                       ...
                                       }elseif($account_details=="Opay"){
                                           echo"Bank Name: Opay <br> Account Number: 7030061196 <br> Account Name: SULAIMAN SAHEED ADEKUNLE";
                                       }elseif($account_details=="Jaizbank"){
                                           echo"Bank Name: Jaiz bank <br> Account Number: 0012883457 <br> Account Name: SASUDEX MULTIBIZ VENTURE";
                                       }
                    ...
                    $stmt = $con->prepare("SELECT btcbuy FROM rates WHERE email = :support_email LIMIT 1");
                    ...
                    $time = date('H:i:s');
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                                ...
                                $message .= "<p style='font-size:14px;margin:0 0 6px 0;'><span style='font-weight:bold;display:inline-block;min-width:150px'>Order type</span> bitcoin USD Purchase</p>";
                    ...
                    <script>
                        ...
                        <div class="modal-header" style="background: #1ab394; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                            ...
                            <div class="modal-body">
                                <?php 
                                    ...
                                    $unformatted_amount_in_dollar = $amount_in_naira / $bitcoin_buy;
                                    $amount_in_dollar = number_format($unformatted_amount_in_dollar, 2);
                                    $formatted_amount_in_dollar = number_format($amount_in_naira / $btcprice, 8);
                                ?>
                              ...
                              The sum of <b><?php echo $amount_in_dollar; ?> USD worth of bitcoin (<?php echo "$formatted_amount_in_dollar"; ?>)</b> shall be funded into your bitcoin wallet<strong style="font-weight:500;font-size:15px;color: #222222;"> after confirmation.</strong></p>
                            </div>
                            <hr>
                      ...
                      <!-- End of order paid successful modal -->
                                ...
                                <form method="POST" action="bitcoin-buy-validation.php" name="frmChange" onSubmit="return validatebtcbuy()">
                                ...
                                <div class="row g-2">                                  
                                  <div class="col mb-0"> 
                                    ...
                                    <?php $reason = array("invalid_AmountInNairalength=true" => "<p style='color:red;'>Min. you can buy is $50 ($formatted_total_bitcoin_min_amount Naira)</p>"); 
                                     if(isset($_GET['purchaseFailedinvalidAmountInNaira'])) echo $reason[$_GET['reason']]; ?>
                                ...
                                <div class="row g-2">                                  
                                  <div class="col mb-0"> 
                                    <label for="AmountInNaira" class="form-label">I will Receive (&#8383;)</label>
                                    <input type="text" id="AmountInBTC" name="AmountInBTC" class="form-control" placeholder="Amount in BTC" />
                                    <span id="BTCAmount" class="required"></span>
                                  </div>
                                  ...
                                  <div class="col mb-3">
                                    <label for="AccountDetails" class="form-label">Your BTC address</label>
                                    <input type="text" id="address" name="address" class="form-control" placeholder="Your BTC address" minlength="26" required/>
                                    <span id="BTCAddress" class="required"></span> 
                                     <?php $reason = array("invalid_Addresscredential=true" => "<p style='color:red;'>Your BTC address is required</p>"); 
                              ...
                              <div class="modal-footer">
                                ...
                                <?php
                                  ...
                                  if ($row['verification_status']==$verification_status){
                                    ...
                                    echo "<button type='submit' name='bitcoinbuy' class='btn btn-primary'>Place Order</button>";
                                 }
                                 }
                        ...
                        AmountInBTC = document.frmChange.AmountInBTC;
                        ...
                        if(!AmountInNaira.value) { 
                            ...
                            address.focus();
                        	document.getElementById("BTCAddress").innerHTML = "<p style='color:red; font-size:13px'>Your BTC address is required</p>";
                        	output = false;
                        }
                        else if(!AmountInBTC.value) {	
                            address.focus();
                        	document.getElementById("BTCamount").innerHTML = "<p style='color:red; font-size:13px'>Something is wrong in BTC amount</p>";
                        	output = false;
                        }
    ...
    <!-- bitcoin Jquery rate calculator script -->
    <script>
    $('#AmountInNaira, #price, #btcprice').on('input',function() {
        ...
        $('#AmountInBTC').val((AmountInNaira / btcprice ? AmountInNaira / btcprice : 0).toFixed(8));   
    }); 
    
    $("form#btcbuyForm").submit(function(){ // on form submit
