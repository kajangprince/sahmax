...
>
  <head>
    ...
    <title>Account Verification - Step 1 of 3</title>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                        ...
                        <center>Take a selfie with your ID card!</center></div>"); 
                        ...
                        if($row['verification_stage']=="1"){
                            ...
                            <center>You did not finish your verification process! <a href='verification-step-two?uid=$id'>Continue from where you stopped
                        ...
                        }elseif($row['verification_stage']=="0"){
                            echo"<div class='card-body alert alert-danger'>
                            <center>Verification Document Rejected! <a href='cancel-review?uid=$id'>Resubmit your Documents
                            <button class='btn btn-primary btn-sm'>Cancel</button></a></center></div>";
                        }else{
                            echo""; 
                        }
                      ...
                      <a href='registration-form'><div class='btn btn-sm btn-outline-primary'>Fill your info</div></a>
                          ...
                          if ($row['verification_status']==$verification_status){
                            ...
                            <h5 class='card-header'><center>Step 1 of 3 - Front of ID card</center></h5>
                            <div class='alert alert-info' style='margin-top:-20px'><center>&ast;We accept only government issued documents. NIN, Driver's License, Passport, and Voters Card.</center>
                            <center>&ast;Select document type and submit a picture of your ID card front.</center></div>
                        <div class='card-body'>
                          <div class='d-flex align-items-start align-items-sm-center gap-4'>
                            ...
                            />
                        <div class='button-wrapper'>
                        <form action='verification-validation-step-one' method='POST' enctype='multipart/form-data'>
                            <label class='form-label' for='document'>&ast;Document type</label>
                            <select name='document' class='select2 form-select' required>  
                           ...
                           <label class='form-label' for='document'>&ast;Submit front of ID</label><br>
                  ...
                  }elseif($row['verification_status']==$verification_rejected){
                      
                    echo"<h5 class='card-header' style='color:#FF0000'><center>Verification Failed!</center></h5>
                    <center><img src='assets/img/illustrations/verification-failed.png' alt='Verification Rejected' width='180' class='img-fluid' style='margin-top:-20px'></center>";
