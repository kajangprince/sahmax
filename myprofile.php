              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="card mb-4">
                   ...
                   <h5 class="card-header">Account Image Upload</h5>
                    <!-- Account -->
                    <div class="card-body">
                    ...
                    if (isset($_POST["upload"])) {
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                            ...
                            if (move_uploaded_file($_FILES["file-input"]["tmp_name"], $target)) {
                                ...
                                $picname = $target;
                            	$updatedp = "UPDATE users SET profile_img = :picname WHERE email = :email LIMIT 1";
                      ...
                      echo"<form>
                        <div class='row'>
                          ...
                          <div class='mb-3 col-md-6'>
                            ...
                            <input class='form-control' type='text' value='$middlename' disabled/>
                          </div>
                          <div class='mb-3 col-md-6'>
                          ...
                          <div class='mb-3 col-md-6'>
                            ...
                            <input type='text' class='form-control' placeholder='$phone_number' disabled/>
                          </div>
                          <div class='mb-3 col-md-6'>
                          ...
                          <div class='mb-3 col-md-6'>
                            <label for='state' class='form-label'>Occupation</label>
                            <input type='text' class='form-control' placeholder='$occupation' disabled/>
                          </div>
                          <div class='mb-3 col-md-6'>
                            <label for='state' class='form-label'>Email</label>
                            <input type='text' class='form-control' placeholder='$email' disabled/>
                          </div>
                          <p>This account was created $formatted_time </p>
                      </form>";
                      }else{
                       echo"<form id='formAccountSettings' method='POST' action='account-settings-validation.php' onsubmit='return true'>
                        <div class='row'>
                          <div class='mb-3 col-md-6'>
                            <label for='firstName' class='form-label'>First Name</label>
                          ...
                          <div class='mb-3 col-md-6'>
                            <label for='lastName' class='form-label'>Surname</label>
                            <input class='form-control' type='text' value='$surname' />
                          </div>
                          <div class='mb-3 col-md-6'>
                        ...
                        <div class='mt-2'>
                          ...
                          <p style='margin-top:20px'>This account was created $formatted_time</p>
                      </form>";
                      }
                      }
