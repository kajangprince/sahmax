                          ...
                          echo "<footer style='border: 1px solid #969696;'>
                              <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <span style='color:#03C3EC'>buy order completed</span> <br><b>Paid to $account_details account</b>
                                </div>
                                <div>
                                  ...
                                  <div class='dropdown dropup footer-link me-3'>
                                    ...
                                    <button type='button' class='btn btn-sm btn-outline-danger' disabled>
                                      <i class='bx bx-log-out-circle'></i> Cancel
                                    </button>
                                </div>
                              </div>
                            </footer>";
              ...
              <!--/ Basic Bootstrap Table -->
                    ...
                    <!-- End of cancel order modal -->
                      ...
                      <!-- End of view buy order modal -->
        			    ...
        			    $stmt = $con->prepare("SELECT order_id , amount_in_usd , receipt , payment_status , order_status , time , date from sell_order WHERE user_id = :user_id AND order_status = :sell_order_status ORDER BY :user_id DESC");
                        $stmt->bindParam(':user_id', $user_id);
                        $stmt->bindParam(':sell_order_status', $sell_order_status);
                        $stmt->execute();
                        ...
                        $time = date('h:i A', $timestamp);
                         ...
                         echo "<footer style='border: 1px solid #969696;'>
                          ...
                          >
                            <div>
                              <a href='javascript:void(0)' class='footer-text fw-bolder'>Order type - $dollar_type USD | Order ID - $sell_order_id | <span style='width:10px;color:#03B0D4'><i class='bx bx-time'></i></span> $time<img src='images/star.gif' style='width:15px;height:15px'></a><br>
                              <span>$date</span> | <span>Amount - &dollar;$formatted_amount_in_usd | <span style='color:#03C3EC'>sell order completed</span><br><b>Paid to your bank account</b>
                            </div>
                            <div>
                              <div class='form-check form-control-sm footer-link me-3'>
                                <button type='button' class='btn btn-sm btn-outline-primary' disabled>
