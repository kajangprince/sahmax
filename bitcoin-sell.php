...
>
  ...
  <body>
        ...
        ?>
                          ...
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/bitcoin-btc-logo.svg" alt="Bitcoin Logo" style="width:20px">BITCOIN SELL</h5>
                                <!--<button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                <div class="row">
                                <span class="alert alert-info">Rate = &#x20A6;<?php echo $bitcoin_sell; ?>/&#36;
                                <!-- Hidden Bitcoin Rate To be Used In Jquery Rate Calculation -->
                                <input type="text" name="price" id="price" <?php echo "value='$bitcoin_sell'"; ?> hidden/>
                                <br>Limit Min. 20 USD = &#x20A6;<?php $bitcoin_min_quantity = "20"; 
                                $total_bitcoin_min_amount = $bitcoin_sell * $bitcoin_min_quantity;
                               ...
                               // CALL MODAL HERE IF ORDER_PLACED
                                ...
                                while($row = $stmt->fetch()){
                                   ...
                                   $formatted_amount_in_usd = number_format($amount_in_usd, 2);
                                    ...
                                    $unformatted_amount_in_naira = $amount_in_usd * $bitcoin_sell;
                                    $amount_in_naira = number_format($unformatted_amount_in_naira, 2);
                                
                                if ($payment_status=="1" AND $dollar_type=="Bitcoin"){
                        ...
                        > 
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/bitcoin-btc-logo.svg" alt="Bitcoin Logo" style="width:20px"><b>BITCOIN SELL</b></h5>
                                </div>
                                <div class='modal-body text-center'>
                                    ...
                                    transactions. Your bank account information must tally with your Sahmax Optimum account name.</div>  
                                <div class='' style='font-size:15px'>
                                    <span><b>ORDER INSTRUCTIONS:</b></span><br>
                                    Note: Bitcoin transactions are volatile, we will pay based on the received amount. <a href="https://coinmarketcap.com/alexandria/glossary/volatility">Learn more</a><br>
                                    <b>1.</b> Send <?php echo "<b>$$amount_in_usd</b>"; ?> worth of bitcoin to the address below <br>
                                    126YcBcmv4SB5PuE5PsxpBwdtBgkWkyFEm<br>
                                    <input style="width:300px;" type="text" value="126YcBcmv4SB5PuE5PsxpBwdtBgkWkyFEm" id="myInput" title="Sahmax Optimum BTC address" readonly>
                                    <p id="myTooltip" onclick="CopyLink()"><button class="btn btn-sm btn-outline-danger"><i class="fa fa-copy" style="font-size:12px;"></i> Copy address</button></p> <br>
                                    ...
                                    function CopyLink() {
                                      ...
                                      tooltip.innerHTML = "<button class='btn btn-primary btn-sm shadow-none'>Address copied</button>";
                                      
                                    setTimeout(function(){
                                    	$("#myTooltip").fadeOut().empty(); //USE THIS LIT SCRIPT TO HIDE A TEXT AFTER SOME MINUTES (USE TO RUN TIPS FUNCTION)
                    ...
                    $stmt = $con->prepare("SELECT btcsell FROM rates WHERE email = :support_email LIMIT 1");
                    ...
                    $time = date('H:i:s');
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                                ...
                                $message .= "<p style='font-size:14px;margin:0 0 6px 0;'><span style='font-weight:bold;display:inline-block;min-width:150px'>Order type</span> Bitcoin USD sell</p>";
                    			...
                    			$subj = "Order Marked Paid ($$formatted_amount_in_usd Bitcoin Sell Order)";
                    ...
                    ?>
                         ...
                         <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <br>
                                ...
                                <br>
                                <div class='alert alert-danger'>***Crypto transactions are volatile, we will pay based on the received amount***</div>
                                </div>            
                                </div>
                            </div>
                            </div>
                    ...
                    <script>
                      ...
                      <!-- End of order paid successful modal -->
                                ...
                                <form method="POST" action="bitcoin-sell-validation.php" name="frmChange" onSubmit="return validateBitcoinSell()">
                                ...
                                <div class="row g-2">                                  
                                  <div class="col mb-0">
                                    ...
                                    <input type="number" id="AmountInUSD" name="AmountInUSD" class="form-control" placeholder="Amount in Dollar" minlength="1" />
                                    ...
                                    <?php $reason = array("invalid_AmountInUSDlength=true" => "<p style='color:red;'>Min. you can sell is &dollar;20</p>"); 
                                     if(isset($_GET['sellFailedinvalidAmountInUSD'])) echo $reason[$_GET['reason']]; ?>
                              ...
                              <div class="modal-footer">
                                ...
                                <?php
                                  ...
                                  if ($row['verification_status']==$verification_status){
                                    ...
                                    echo "<button type='submit' name='bitcoinsell' class='btn btn-primary'>Place Order</button>";
                                 }
                                 }
    ...
    $("form#BitcoinBuyForm").submit(function(){ // on form submit
