              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="account-settings-validation.php" onsubmit="return false">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-12 mb-md-0 mb-4">
                      <div class="card">
                        ...
                        <div class="card-body">
                          <p>This settings affects your use of Sahmax Optimum</p>
                          <!-- Connections -->                                                      
                          <div class="d-flex mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              <div class="col-9 mb-sm-0 mb-2">
                                <h6 class="mb-0">Unusual activity notification</h6>
                                <small class="text-muted">You will receive unusual activity notification.</small>
                              </div>
                         ...
                         <?php
                          // Check if user has security pin activated
                          $empty_pin_code = "";
                          $sql = $con->prepare("SELECT pin_code FROM users WHERE email = :email LIMIT 1");
                          $sql->execute(array('email' => $email));
                          if($sql->rowCount() > 0){
                          $row = $sql->fetch(PDO::FETCH_ASSOC);
                          if ($row['pin_code']==$empty_pin_code){
                            echo "<small class='text-muted'><div class='alert alert-danger'>There is an issue with your default account 
                            security pin, please contact support.</div></small>";
                          } else {
                            $pin_code = ($row['pin_code']);
                            echo "<small class='text-muted'>Your default security pin is $pin_code.
                                 This pin will be required during transaction verification.</small>";
                    ...
                    <div class="col-md-6 col-12">
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex mb-3">
                            ...
                            <div class="flex-grow-1 row">
                              ...
                              <div class="col-3 text-end">
                                <div class="form-check form-switch" onclick="themeToggle()">
                        ...
                        <?php
                          // Check if user has voilated company policy
                          $account_status = "0";
                          $sql = $con->prepare("SELECT account_status FROM users WHERE email = :email LIMIT 1");
                          $sql->execute(array('email' => $email));
                          if($sql->rowCount() > 0){
                          $row = $sql->fetch(PDO::FETCH_ASSOC);
                          if ($row['account_status']== $account_status){
                            echo "<small class='text-muted'>You have not violated our policy</small>";
                          } else {
                            echo "<small class='text-muted'><div class='alert alert-danger'>Critical account condition. 
                            Please contact support to avoid account deactivation. </div></small>";
                          }
                        }
