...
>
  <head>
    ...
    <title>Account Orders - Paid</title>
      ...
      <div class="layout-container">
        ...
        <!-- end of rates section -->
            <!-- / Content -->
                ...
                $stmt =  $stmt = $con->prepare("SELECT * FROM buy_order WHERE payment_status = :payment_status AND order_status = :order_status AND user_id = :user_id");
                          ...
                          echo "<footer style='border: 1px solid #969696;'>
                              <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br><b>Paid to $account_details account</b>
                                </div>
                                <div>
                          ...
                          echo "<footer style='border: 1px solid #969696;'>
                              <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <br> <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br><b>Paid to $account_details account</b>
                                </div>
                                <div>
                                  <div class='form-check form-control-sm footer-link me-3'>
                                    <button type='button' class='btn btn-sm btn-outline-primary' disabled>
                          ...
                          echo "<footer style='border: 1px solid #969696;'>
                              <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br>
                                  <b><span>$wallet_address - $network</span></b></span>
                                </div>
                                <div>
                                  <div class='form-check form-control-sm footer-link me-3'>
                                    <button type='button' class='btn btn-sm btn-outline-primary' disabled>
                          ...
                          echo "<footer style='border: 1px solid #969696;'>
                              <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &#8358;$formatted_amount_in_naira | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span></b>
                                </div>
                                <div>
                                  <div class='form-check form-control-sm footer-link me-3'>
                                    <button type='button' class='btn btn-sm btn-outline-primary' disabled>
              ...
              <!--/ Basic Bootstrap Table -->
                    ...
                    <!-- End of cancel Buy order modal -->
                      ...
                      <!-- End of view USDT buy order modal -->
                                ...
                                $stmt =  $stmt = $con->prepare("SELECT * FROM sell_order WHERE payment_status = :payment_status AND order_status = :order_status AND user_id = :user_id");
                                $stmt->bindParam(':user_id', $user_id);
                                $stmt->bindParam(':payment_status', $payment_status);
                                $stmt->bindParam(':order_status', $order_status);
                                $stmt->execute();
                                if($stmt){
                                    ...
                                    while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                                        ...
                                        $sell_account_details = $row['account_details'];
                                        $amount_in_usd = $row['amount_in_usd'];
                                        $sell_receipt = $row['receipt'];
                                        //Formatted amount in Dollar to be used in email message
                                        $sell_formatted_amount_in_usd = number_format($amount_in_usd, 2);
                                        
                                        $sell_unformatted_date =  $row['date'];
                                        $sell_datestamp = strtotime($sell_unformatted_date);
                                        $sell_date = date('d F Y', $sell_datestamp);
                                        
                                        $sell_unformatted_time =  $row['time'];
                                        $sell_timestamp = strtotime($sell_unformatted_time);
                                        $sell_time = date('h:i A', $sell_timestamp);
                                ...
                                echo"<script>
                                  ...
                                  echo "<footer style='border: 1px solid #969696;'>
                                      <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                        <div>
                                          <a href='javascript:void(0)' class='footer-text fw-bolder'>Deriv Sell Order | Order ID - $sell_order_id | <span style='width:10px;color:#03B0D4'><i class='bx bx-time'></i></span> $sell_time<img src='images/star.gif' style='width:15px;height:15px'></a><br>
                                          <span>$sell_date</span> | <span>Amount  - &dollar;$sell_formatted_amount_in_usd | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br><b>Paid to your bank account</b>
                                        </div>
                                        <div>
                                          <div class='form-check form-control-sm footer-link me-3'>
                                            <button type='button' class='btn btn-sm btn-outline-primary' disabled>
                                  ...
                                  echo "<footer style='border: 1px solid #969696;'>
                                      <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                        <div>
                                          <a href='javascript:void(0)' class='footer-text fw-bolder'>Bitcoin Sell Order | Order ID - $sell_order_id | <span style='width:10px;color:#03B0D4'><i class='bx bx-time'></i></span> $sell_time<img src='images/star.gif' style='width:15px;height:15px'></a><br>
                                          <span>$sell_date</span> | <span>Amount  - &dollar;$sell_formatted_amount_in_usd | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br><b>Paid to your bank account</b>
                                        </div>
                                        <div>
                                          <div class='form-check form-control-sm footer-link me-3'>
                                  ...
                                  echo "<footer style='border: 1px solid #969696;'>
                                      <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                        <div>
                                          <a href='javascript:void(0)' class='footer-text fw-bolder'>USDT Sell Order | Order ID - $sell_order_id | <span style='width:10px;color:#03B0D4'><i class='bx bx-time'></i></span> $sell_time<img src='images/star.gif' style='width:15px;height:15px'></a><br>
                                          <span>$sell_date</span> | <span>Amount  - &dollar;$sell_formatted_amount_in_usd | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br>
                                        </div>
                                        <div>
                                          <div class='form-check form-control-sm footer-link me-3'>
                                            <button type='button' class='btn btn-sm btn-outline-primary' disabled>
                                    ...
                                    echo "<footer style='border: 1px solid #969696;'>
                                      <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                        <div>
                                          <a href='javascript:void(0)' class='footer-text fw-bolder'>PM Sell Order | Order ID - $sell_order_id | <span style='width:10px;color:#03B0D4'><i class='bx bx-time'></i></span> $sell_time<img src='images/star.gif' style='width:15px;height:15px'></a><br>
                                          <span>$sell_date</span> | <span>Amount  - &dollar;$sell_formatted_amount_in_usd | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br><b>Paid to your bank account</b>
                                        </div>
                                        <div>
                                          <div class='form-check form-control-sm footer-link me-3'>
                                    ...
                                    echo "<footer style='border: 1px solid #969696;'>
                                      <div class='container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3'>
                                        <div>
                                          <a href='javascript:void(0)' class='footer-text fw-bolder'>Neteller Sell Order | Order ID - $sell_order_id | <span style='width:10px;color:#03B0D4'><i class='bx bx-time'></i></span> $sell_time<img src='images/star.gif' style='width:15px;height:15px'></a><br>
                                          <span>$sell_date</span> | <span>Amount  - &dollar;$sell_formatted_amount_in_usd | <span style='color:#03C3EC'>wait time <span id='seconds'></span>sec</span><br><b>Paid to your bank account</b>
                                        </div>
                                        <div>
                                          <div class='form-check form-control-sm footer-link me-3'>
                    ...
                    <!-- End of cancel sell order modal -->
                                ...
                                while($row = $stmt->fetch()){
                                   ...
                                   //Formatted amount in Naira to be used in email message
                                   $formatted_amount_in_usd = number_format($sell_amount_in_usd, 2);
                      ...
                      <!-- End of view sell order modal -->
                        ...
                        <!-- Start of view Bitcoin Sell order modal -->
                        ...
                        <div class="modal-header" style="background: #1ab394; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                            ...
                            <div class="modal-body">
                                    ...
                                    //Get order Naira amount
                                    $unformatted_amount_in_usd = $amount_in_usd * $bitcoin_sell;
                                    $amount_in_naira = number_format($unformatted_amount_in_naira, 2);
                      ...
                      <!-- End of view Bitcoin sell order modal -->
                      ...
                      <!-- End of USDTSellPaidModal -->
                        ...
                        <!-- Start of view PM Sell order modal -->
                        ...
                        <div class="modal-header" style="background: #1ab394; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                            ...
                            <div class="modal-body">
                                    ...
                                    //Get order Naira amount
                                    $unformatted_amount_in_usd = $amount_in_usd * $pm_sell;
                                    $amount_in_naira = number_format($unformatted_amount_in_naira, 2);
                      ...
                      <!-- End of view PM sell order modal -->
