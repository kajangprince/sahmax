...
>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        ?>
                        ...
                        <!-- Perefect Money Sell Funds Modal -->
                        <div
                          ...
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/neteller-logo.png" alt="Neteller Logo" style="width:20px">NETELLER SELL</h5>
                                <!--<button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                <div class="row">
                                <span class="alert alert-info">Rate = &#x20A6;<?php echo $neteller_sell; ?>/&#36;
                                <!-- Hidden Neteller Rate To be Used In Jquery Rate Calculation -->
                                <input type="text" name="price" id="price" <?php echo "value='$neteller_sell'"; ?> hidden/>
                                <br>Limit Min. 20 USD = &#x20A6;<?php $neteller_min_quantity = "20"; 
                                $total_neteller_min_amount = $neteller_sell * $neteller_min_quantity;
                                /* Format Amount to decimal place */
                                $formatted_total_neteller_min_amount = number_format($total_neteller_min_amount); echo"$formatted_total_neteller_min_amount"; ?> </span>
                               ...
                               // CALL MODAL HERE IF ORDER_PLACED
                                ...
                                while($row = $stmt->fetch()){
                                   ...
                                   $formatted_amount_in_usd = number_format($amount_in_usd, 2);
                                    ...
                                    $unformatted_amount_in_naira = $amount_in_usd * $neteller_sell;
                                    $amount_in_naira = number_format($unformatted_amount_in_naira, 2);
                                
                                if ($payment_status=="1" AND $dollar_type=="Neteller"){
                        ...
                        > 
                          <div class="modal-dialog modal-fullscreen" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalToggleLabel"><img src="images/neteller-logo.png" alt="Neteller Logo" style="width:20px"><b>NETELLER SELL</b></h5>
                                </div>
                                <div class='modal-body text-center'>
                                    ...
                                    transactions. Your bank account information must tally with your Sahmax Optimum and Neteller account name.</div>  
                                <div class='' style='font-size:15px'>
                                    <span><b>ORDER INSTRUCTIONS:</b></span><br>                       
                                    <b>1.</b> Send <?php echo "<b>$$amount_in_usd</b>"; ?> to the Neteller Account below <br> raheemsuliyat92@gmail.com <br>
                                    <input style="width:215px;" type="text" value="raheemsuliyat92@gmail.com" id="myInput" title="Sahmax Optimum Neteller Email" readonly> 
                                    <p id="myTooltip" onclick="CopyLink()"><button class="btn btn-sm btn-outline-danger"><i class="fa fa-copy" style="font-size:12px;"></i> Copy Neteller Email</button></p> <br>
                                    ...
                                    function CopyLink() {
                                      ...
                                      tooltip.innerHTML = "<button class='btn btn-primary btn-sm shadow-none'>Neteller Email copied</button>";
                    ...
                    $dollar_type = "Neteller";
                    
                    $support_email = "support@sahmax.com";
                    
                    $stmt = $con->prepare("SELECT netellersell FROM rates WHERE email = :support_email LIMIT 1");
                    ...
                    $time = date('H:i:s');
                        ...
                        if (! file_exists($_FILES["file-input"]["tmp_name"])) {
                                ...
                                $message .= "<p style='font-size:14px;margin:0 0 6px 0;'><span style='font-weight:bold;display:inline-block;min-width:150px'>Order type</span> Neteller USD sell</p>";
                    			...
                    			$subj = "Order Marked Paid ($$formatted_amount_in_usd Neteller Sell Order)";
                    ...
                    ?>
                         ...
                         <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <br>
                                ...
                                <br>
                                <div class='alert alert-danger'>***Payment should be made from your personal account. No third parties***</div>
                                </div>            
                                </div>
                            </div>
                            </div>
                    ...
                    <script>
                        ...
                        <div class="modal-header" style="background: #1ab394; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                            ...
                            <div class="modal-body">
                                <?php 
                                    //Get order Naira amount
                                    $unformatted_amount_in_usd = $amount_in_usd * $neteller_sell;
                      ...
                      <!-- End of order paid successful modal -->
                                ...
                                <form method="POST" action="neteller-sell-validation.php" name="frmChange" onSubmit="return validateNetellerSell()">
                              ...
                              <div class="modal-footer">
                                ...
                                <?php
                                  ...
                                  if ($row['verification_status']==$verification_status){
                                    ...
                                    echo "<button type='submit' name='netellersell' class='btn btn-primary'>Place Order</button>";
                                 }
                                 }
    ...
    <!-- Neteller Jquery rate calculator script -->
    <script>
    ...
    $("form#NetellerBuyForm").submit(function(){ // on form submit
