...
>
  <head>
    ...
    <title>Admin active sell orders</title>
          ...
          <div class="content-wrapper">
            <!-- Content -->
              ...
              <div class="card">
                ...
                <!-- Order Removed success message -->  
                <?php $reason = array("success=true" => "<p class='card-header' style='color:green; font-size:16px; margin-bottom:-40px'>Order Removed</p>"); 
                if(isset($_GET['RemovedSuccess'])) echo $reason[$_GET['reason']]; ?>
                  
                <!-- Order Not Removed success message -->  
                <?php $reason = array("failed=true" => "<p class='card-header' style='color:red; font-size:16px; margin-bottom:-40px'>Order Not Removed</p>"); 
                if(isset($_GET['RemovedFailed'])) echo $reason[$_GET['reason']]; ?>
                  
                <h5 class="card-header">Paid Sell Orders</h5>
                 ...
                 <div class="table-responsive text-nowrap">
                    ...
                    include_once("pdoconfig.php");
        			    ...
        			    $stmt = $con->prepare("SELECT id , user_id, dollar_type , order_id , amount_in_usd , receipt , payment_status , order_status , time , date from sell_order WHERE payment_status = :payment_status AND order_status = :order_status");
                        ...
                        echo "<footer style='border: 1px solid #969696;'>
                              ...
                              >
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &dollar;$formatted_amount_in_usd | <img src='$receipt' style='width:50px;height:50px'> | <span style='color:#03C3EC'> paid </span><br><b>Paid to your account</b>
                                </div>
                                <div> 
                                ...
                                <div class='form-check form-control-sm footer-link me-3'>
                    			<form action='admin-active-sell-orders' method='POST'>
                    			    <input type='hidden' name='orderid' value='$order_id'/>
                    				<button type='submit' name='dispute' class='btn btn-sm btn-outline-danger'>Dispute</button>
                    			</form>
                    			</div>
                    			...
                    			<form action='admin-active-sell-orders' method='POST'>
                    			    <input type='hidden' name='orderid' value='$order_id'/>
                    				<button type='submit' name='markdone' class='btn btn-sm btn-primary'>Mark Done</button>
                    			</form>
                    			</div>
                    			
                    			<br>
                                <div class='form-check form-control-sm footer-link me-3'>
                                    <a href='admin-cancel-sell-order?oid=$order_id' class='btn btn-sm btn-outline-danger'><i class='bx bx-log-out-circle'></i> Cancel</a>
                                </div>
              ...
              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Unpaid Sell Orders</h5>
                        ...
                        echo "<footer style='border: 1px solid #969696;'>
                              ...
                              >
                                <div>
                                  ...
                                  <span>$date</span> | <span>Amount  - &dollar;$formatted_amount_in_usd | <span style='color:#E6381A'> unpaid </span><br><b>Paying to your account</b>
                                </div>
                                <div>
                    			...
                    			<form action='admin-active-sell-orders' method='POST'>
                    			    <input type='hidden' name='orderid' value='$order_id'/>
                    				<button type='submit' name='markdone' class='btn btn-sm btn-primary' disabled>Mark Done</button>
                    			</form>
                    			</div>
              ...
              <?php
                ...
                if(isset($_POST['dispute'])){
                    ...
                    $dispute_query = "UPDATE sell_order SET dispute_level = :dispute_level WHERE order_id = :order_id LIMIT 1";		
              ...
              <?php
                ...
                if(isset($_POST['markdone'])){
                    ...
                    $markorder_query = "UPDATE sell_order SET order_status = :order_status WHERE order_id = :order_id LIMIT 1";		
                            ...
                            <div class="modal-header" style=" background: #1ab394; border-top-left-radius: 5px; border-top-right-radius: 5px;">
                              <h4 class="modal-title text-center"></h4>
                                ...
                                <div class="modal-body">
                                  ...
                                  <p style="text-align:center;color:#555555;"><a href="admin-active-sell-orders">Refresh page</a></p>
                                </div>
                              <div class="modal-footer">
                             <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
                         </div>
