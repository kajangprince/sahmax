        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Account /</span> Clients</h4>

              <!-- Basic Bootstrap Table -->
              <div class="card">
                <h5 class="card-header">Sahmax Optimum Clients</h5>
                ...
                if($stmt){
                    ...
                    <li data-bs-toggle='tooltip' data-popup='tooltip-custom' data-bs-placement='top' class='avatar avatar-xs pull-up' title='Profile pic'
                    >
                    <img src='$row->profile_img' alt='Profile pic' class='rounded-circle' />
                     </li>
                     </ul>
                     </td>
                     <td>$row->pin_code</td>
                    ...
                    <td>$row->email</td>
                    <td>
                        <form action='deactivate-user-validation.php' method='POST'>
                        <input type='hidden' name='id' value='$row->id'/>
                        <button type='submit' name='deactivate_user' class='btn btn-danger'><i class='menu-icon tf-icons bx bx-bx bx-user-x me-1'></i>
                        </button>
                        </form>
                    </td>
                    <td>
                        <form action='reactivate-user-validation.php' method='POST'>
                        <input type='hidden' name='id' value='$row->id'/>
                        <button type='submit' name='reactivate_user' class='btn btn-primary'><i class='menu-icon tf-icons bx bx-bx bx-user-plus me-1'></i>
                        </button>
                        </form>
                    </td>
                    <td>
                        <a href='admin-update?uid=$row->id'><i class='menu-icon tf-icons bx bx-bx bx bx-edit-alt me-1'></i>
                        </a>
                    </td>
